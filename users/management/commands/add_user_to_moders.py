...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('user_id', type=int, help='ID пользователя для добавления в группу moders')
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS(f'Пользователь {user.username} добавлен в группу moders.'))